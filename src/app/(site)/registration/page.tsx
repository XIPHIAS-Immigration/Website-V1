...
export const metadata: Metadata = {
  ...
  description: "Register for a full XIPHIAS immigration assessment, Deep Analysis and secure client CRM onboarding for ₹5,000 including GST.",
      ...
      <section className="bg-primary text-white">
        <div className="mx-auto grid max-w-screen-xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-white/65">For ₹5,000 including GST, start a structured immigration assessment, receive the included Deep Analysis and manage the next steps in the XIPHIAS client CRM.</p>
